...
#define DELTA
  ...
  #define PRINTABLE_RADIUS       80.0    // (mm)
  ...
  #define DELTA_ENDSTOP_ADJ { -0.79, 0.0, -1.16 } // (mm) Get these values from G33 auto calibrate
  ...
  #define DELTA_TOWER_ANGLE_TRIM { -0.11, 0.37, -0.26 } // (mm) Get these values from G33 auto calibrate

  // Delta radius and diagonal rod adjustments
  #define DELTA_RADIUS_TRIM_TOWER       { -0.22, 0.17, 0.04 } // (mm)
