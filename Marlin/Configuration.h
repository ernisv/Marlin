...
#define STRING_CONFIG_H_AUTHOR "Ernestas, bl+fil" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ernesto Ender-3 V2"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -20, -3.30 }
